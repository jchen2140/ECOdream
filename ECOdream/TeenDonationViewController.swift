//
//  TeenDonationViewController.swift
//  ECOdream
//
...
class TeenDonationViewController: UIViewController {

    @IBAction func goodwillDono(_ sender: UIButton) {
    ...
    @IBAction func armyDono(_ sender: UIButton) {
    ...
    @IBAction func buffalloDono(_ sender: Any) {
